...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/jia/Downloads/best.pt', help='model.pt path(s)')
    parser.add_argument('--source1', type=str, default='/home/jia/dataset/bird/images/val/', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str, default='/home/jia/dataset/bird/image/val/', help='source')  # file/folder, 0 for webcam
