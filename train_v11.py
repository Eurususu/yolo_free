...
import test_v11  # import test.py to get mAP after each epoch
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if rank in [-1, 0]:
            ...
            if not opt.notest or final_epoch:  # Calculate mAP
                ...
                results, maps, times = test_v11.test(data_dict,
    ...
    if rank in [-1, 0]:
        ...
        if opt.data.endswith('coco.yaml') and nc == 80:  # if COCO
            for m in (last, best) if best.exists() else (last):  # speed, mAP tests
                results, _, _ = test_v11.test(opt.data,
                                          batch_size=batch_size * 2,
                                          imgsz=imgsz_test,
                                          conf_thres=0.001,
                                          iou_thres=0.7,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='./models/hub/yolov9s.yaml', help='model.yaml path')
    ...
    parser.add_argument('--optim', type=str, default='auto', help='choose optim "Adam", "Adamax", "AdamW", "NAdam", "RAdam", "RMSProp", "SGD", "auto"')
