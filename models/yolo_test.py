...
from models.yolo import Detect_yolov11
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='/home/jia/PycharmProjects/multispectral-object-detection/models/transformer/yolov11s_fusion_transformer_vedai.yaml', help='model.yaml')
