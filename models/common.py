...
class Bottleneck_v11(nn.Module):
    """Standard bottleneck."""
...
class C2(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        ...
        self.m = nn.Sequential(*(Bottleneck_v11(self.c, self.c, shortcut, g, k=((3, 3), (3, 3)), e=1.0) for _ in range(n)))
...
class C2f(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        ...
        self.m = nn.ModuleList(Bottleneck_v11(self.c, self.c, shortcut, g, k=((3, 3), (3, 3)), e=1.0) for _ in range(n))
...
class C3k2(C2f):
    ...
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        ...
        self.m = nn.ModuleList(
            C3k(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_v11(self.c, self.c, shortcut, g) for _ in range(n)
        )
...
class C3k(C3):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5, k=3):
        ...
        self.m = nn.Sequential(*(Bottleneck_v11(c_, c_, shortcut, g, k=(k, k), e=1.0) for _ in range(n)))
...
class RepBottleneck(Bottleneck_v11):
    """Rep bottleneck."""
